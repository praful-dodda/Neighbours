function [zk,vk]=krigingME_stug(ck,ch,cs,zh,zs,vs,covmodel,covparam,nhmax,nsmax,dmax,order,options, softdata);
...
for i=1:nk
  ...
  if isempty(softdata)
    ...
    [cslocal,zslocal,~,sumnslocal,index]=neighbours_stug(ck0,cs,zs,nsmax,dmax);
  end
